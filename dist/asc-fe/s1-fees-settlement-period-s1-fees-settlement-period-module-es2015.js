...
let S1FeesSettlementPeriodComponent = /*@__PURE__*/ (() => {
    class S1FeesSettlementPeriodComponent {
        ...
        getList() {
            this.apiService.findAll(_shared__WEBPACK_IMPORTED_MODULE_4__["ENDPOINTS"].s1FeesSettlementPeriod).subscribe((res) => {
        ...
        save() {
            this.apiService.save(_shared__WEBPACK_IMPORTED_MODULE_4__["ENDPOINTS"].s1FeesSettlementPeriod, this.s1FeeSettlementPeriod).subscribe((res) => {
                if (res !== undefined) {
        ...
        getS1FeeSettlementPeriod() {
            this.apiService.findById(_shared__WEBPACK_IMPORTED_MODULE_4__["ENDPOINTS"].s1FeesSettlementPeriod, this.formListComponent.idForUpdate).subscribe((res) => {
                if (res) {
        ...
        update() {
            this.apiService.update(_shared__WEBPACK_IMPORTED_MODULE_4__["ENDPOINTS"].s1FeesSettlementPeriod, this.s1FeeSettlementPeriod).subscribe((res) => {
                if (res !== undefined) {
                    this.sweetAlertService.success(res);
                }
            }, (err) => {
        ...
        delete() {
            sweetalert2__WEBPACK_IMPORTED_MODULE_6___default.a.fire({
                ...
                if (result.value) {
                    this.apiService.deleteById(_shared__WEBPACK_IMPORTED_MODULE_4__["ENDPOINTS"].s1FeesSettlementPeriod, this.s1FeeSettlementPeriod.id).subscribe(() => {
    ...
    S1FeesSettlementPeriodComponent.ɵfac = function S1FeesSettlementPeriodComponent_Factory(t) { return new (t || S1FeesSettlementPeriodComponent)(_angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵdirectiveInject"](_services__WEBPACK_IMPORTED_MODULE_7__["ApiService"]), _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵdirectiveInject"](_angular_forms__WEBPACK_IMPORTED_MODULE_1__["FormBuilder"]), _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵdirectiveInject"](_services__WEBPACK_IMPORTED_MODULE_7__["SweetAlertService"]), _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵdirectiveInject"](app_core_services_validate_field_service__WEBPACK_IMPORTED_MODULE_8__["ValidateFieldService"])); };
    S1FeesSettlementPeriodComponent.ɵcmp = _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵdefineComponent"]({ type: S1FeesSettlementPeriodComponent, selectors: [["app-s1-fees-settlement-period"]], viewQuery: function S1FeesSettlementPeriodComponent_Query(rf, ctx) {
            if (rf & 1) {
            ...
            if (rf & 1) {
                ...
                _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵtext"](5, " S1 Fees Settlement Period ");
                ...
                _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵtext"](11, "Number of Hours ");
                _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵelementStart"](12, "span", 5);
                _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵtext"](13, "*");
                _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵelementEnd"]();
                _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵelementEnd"]();
                _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵelementStart"](14, "input", 6);
                _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵlistener"]("ngModelChange", function S1FeesSettlementPeriodComponent_Template_input_ngModelChange_14_listener($event) { return ctx.s1FeeSettlementPeriod.noOfHours = $event; })("keydown", function S1FeesSettlementPeriodComponent_Template_input_keydown_14_listener($event) { return ctx.validateFieldService.numbersOnly($event); });
                _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵelementEnd"]();
                _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵelementEnd"]();
                _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵelementStart"](15, "mat-form-field", 4);
                _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵelementStart"](16, "mat-label");
                _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵtext"](17, "Number of Days ");
                ...
                _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵlistener"]("ngModelChange", function S1FeesSettlementPeriodComponent_Template_input_ngModelChange_20_listener($event) { return ctx.s1FeeSettlementPeriod.noOfDays = $event; })("keydown", function S1FeesSettlementPeriodComponent_Template_input_keydown_20_listener($event) { return ctx.validateFieldService.numbersOnly($event); });
                _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵelementEnd"]();
                _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵelementEnd"]();
                _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵelementEnd"]();
                _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵelementEnd"]();
                _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵelementStart"](21, "app-form-action-buttons", 8);
                _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵlistener"]("saveFunction", function S1FeesSettlementPeriodComponent_Template_app_form_action_buttons_saveFunction_21_listener() { return ctx.save(); })("updateFunction", function S1FeesSettlementPeriodComponent_Template_app_form_action_buttons_updateFunction_21_listener() { return ctx.update(); })("cancelFunction", function S1FeesSettlementPeriodComponent_Template_app_form_action_buttons_cancelFunction_21_listener() { return ctx.resetFormValidator(); })("deleteFunction", function S1FeesSettlementPeriodComponent_Template_app_form_action_buttons_deleteFunction_21_listener() { return ctx.delete(); });
                _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵelementEnd"]();
                _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵelement"](22, "br");
                _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵelementStart"](23, "app-form-list", 9);
                _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵlistener"]("selectInListFunction", function S1FeesSettlementPeriodComponent_Template_app_form_list_selectInListFunction_23_listener() { return ctx.getS1FeeSettlementPeriod(); });
                _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵelementEnd"]();
                _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵelementEnd"]();
                _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵelementEnd"]();
            }
            if (rf & 2) {
                ...
                _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵproperty"]("formGroup", ctx.s1FeeSettlementPeriodForm);
                _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵadvance"](7);
                _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵproperty"]("ngModel", ctx.s1FeeSettlementPeriod.noOfHours);
                _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵadvance"](6);
                _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵproperty"]("ngModel", ctx.s1FeeSettlementPeriod.noOfDays);
                _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵadvance"](1);
                _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵproperty"]("childObject", ctx.s1FeeSettlementPeriod)("childForm", ctx.s1FeeSettlementPeriodForm);
...
/* harmony import */ var _s1_fees_settlement_period_component__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ./s1-fees-settlement-period.component */ "IXEc");
...
let S1FeesSettlementPeriodRoutingModule = /*@__PURE__*/ (() => {
    class S1FeesSettlementPeriodRoutingModule {
    }
    S1FeesSettlementPeriodRoutingModule.ɵmod = _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵdefineNgModule"]({ type: S1FeesSettlementPeriodRoutingModule });
    S1FeesSettlementPeriodRoutingModule.ɵinj = _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵdefineInjector"]({ factory: function S1FeesSettlementPeriodRoutingModule_Factory(t) { return new (t || S1FeesSettlementPeriodRoutingModule)(); }, imports: [[_angular_router__WEBPACK_IMPORTED_MODULE_1__["RouterModule"].forChild(routes)], _angular_router__WEBPACK_IMPORTED_MODULE_1__["RouterModule"]] });
    return S1FeesSettlementPeriodRoutingModule;
})();
(function () { (typeof ngJitMode === "undefined" || ngJitMode) && _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵsetNgModuleScope"](S1FeesSettlementPeriodRoutingModule, { imports: [_angular_router__WEBPACK_IMPORTED_MODULE_1__["RouterModule"]], exports: [_angular_router__WEBPACK_IMPORTED_MODULE_1__["RouterModule"]] }); })();
...
/* harmony import */ var _s1_fees_settlement_period_routing_module__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ./s1-fees-settlement-period-routing.module */ "YJnU");
...
let S1FeesSettlementPeriodModule = /*@__PURE__*/ (() => {
    class S1FeesSettlementPeriodModule {
    }
    S1FeesSettlementPeriodModule.ɵmod = _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵdefineNgModule"]({ type: S1FeesSettlementPeriodModule });
    S1FeesSettlementPeriodModule.ɵinj = _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵdefineInjector"]({ factory: function S1FeesSettlementPeriodModule_Factory(t) { return new (t || S1FeesSettlementPeriodModule)(); }, imports: [[
                _angular_common__WEBPACK_IMPORTED_MODULE_1__["CommonModule"],
                _s1_fees_settlement_period_routing_module__WEBPACK_IMPORTED_MODULE_2__["S1FeesSettlementPeriodRoutingModule"],
...
(function () {
    (typeof ngJitMode === "undefined" || ngJitMode) && _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵsetNgModuleScope"](S1FeesSettlementPeriodModule, { declarations: [_s1_fees_settlement_period_component__WEBPACK_IMPORTED_MODULE_3__["S1FeesSettlementPeriodComponent"]], imports: [_angular_common__WEBPACK_IMPORTED_MODULE_1__["CommonModule"],
            _s1_fees_settlement_period_routing_module__WEBPACK_IMPORTED_MODULE_2__["S1FeesSettlementPeriodRoutingModule"],
            _angular_common_http__WEBPACK_IMPORTED_MODULE_7__["HttpClientModule"],
            _angular_forms__WEBPACK_IMPORTED_MODULE_6__["ReactiveFormsModule"],
            _shared__WEBPACK_IMPORTED_MODULE_5__["AngularMaterialModule"],
