...
/* harmony import */ var _raw_loader_company_penalties_component_html__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! raw-loader!./company-penalties.component.html */ "SqLI");
/* harmony import */ var _company_penalties_component_scss__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ./company-penalties.component.scss */ "Q+RH");
...
/* harmony import */ var app_core_models_company_penalties_model__WEBPACK_IMPORTED_MODULE_10__ = __webpack_require__(/*! app/core/models/company-penalties.model */ "fJLi");
...
let CompanyPenaltiesComponent = class CompanyPenaltiesComponent {
    ...
    getCompanyPenaltiesList() {
        this.apiService.findAll(_shared__WEBPACK_IMPORTED_MODULE_9__["ENDPOINTS"].companyPenalties).subscribe((res) => {
            if (res) {
    ...
    getCompanyPenalties() {
        this.apiService.findById(_shared__WEBPACK_IMPORTED_MODULE_9__["ENDPOINTS"].companyPenalties, this.formListComponent.idForUpdate).subscribe((res) => {
            if (res) {
    ...
    getCompanyList() {
        this.apiService.findAll(_shared__WEBPACK_IMPORTED_MODULE_9__["ENDPOINTS"].activeCompanies).subscribe((res) => {
            if (res) {
    ...
    save() {
        this.formatDate();
        this.apiService.save(_shared__WEBPACK_IMPORTED_MODULE_9__["ENDPOINTS"].companyPenalties, this.companyPenalties).subscribe((res) => {
            if (res) {
    ...
    update() {
        this.apiService.update(_shared__WEBPACK_IMPORTED_MODULE_9__["ENDPOINTS"].companyPenalties, this.companyPenalties).subscribe((res) => {
            if (res) {
                this.sweetAlertService.success(res);
            }
            else {
    ...
    delete() {
        sweetalert2__WEBPACK_IMPORTED_MODULE_11___default.a.fire({
            ...
            if (result.value) {
                this.apiService.deleteById(_shared__WEBPACK_IMPORTED_MODULE_9__["ENDPOINTS"].companyPenalties, this.companyPenalties.id).subscribe(() => {
...
CompanyPenaltiesComponent.ctorParameters = () => [
...
CompanyPenaltiesComponent = Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"])([
...
let CompanyPenaltiesRoutingModule = class CompanyPenaltiesRoutingModule {
};
CompanyPenaltiesRoutingModule = Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"])([
...
/* harmony import */ var _company_penalties_routing_module__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ./company-penalties-routing.module */ "CMYt");
/* harmony import */ var _company_penalties_component__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! ./company-penalties.component */ "AF0P");
...
let CompanyPenaltiesModule = class CompanyPenaltiesModule {
};
CompanyPenaltiesModule = Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"])([
    Object(_angular_core__WEBPACK_IMPORTED_MODULE_1__["NgModule"])({
        declarations: [_company_penalties_component__WEBPACK_IMPORTED_MODULE_4__["CompanyPenaltiesComponent"]],
        imports: [
            _angular_common__WEBPACK_IMPORTED_MODULE_2__["CommonModule"],
            _company_penalties_routing_module__WEBPACK_IMPORTED_MODULE_3__["CompanyPenaltiesRoutingModule"],
