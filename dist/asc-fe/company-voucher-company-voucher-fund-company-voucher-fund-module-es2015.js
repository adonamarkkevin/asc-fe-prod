...
let CompanyVoucherFundRoutingModule = class CompanyVoucherFundRoutingModule {
};
CompanyVoucherFundRoutingModule = Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"])([
...
/* harmony import */ var tslib__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! tslib */ "mrSG");
/* harmony import */ var _raw_loader_company_voucher_fund_component_html__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! raw-loader!./company-voucher-fund.component.html */ "YH1i");
/* harmony import */ var _company_voucher_fund_component_scss__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ./company-voucher-fund.component.scss */ "keJH");
/* harmony import */ var _core_services_data_storage_service__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ./../../../../../core/services/data.storage.service */ "nBem");
...
/* harmony import */ var app_core_models_voucher_replenishment_model__WEBPACK_IMPORTED_MODULE_13__ = __webpack_require__(/*! app/core/models/voucher-replenishment.model */ "C+gi");
...
let CompanyVoucherFundComponent = class CompanyVoucherFundComponent {
    constructor(formBuilder, router, apiService, sweetAlertService, sanitizer, fileStorageService, dataStorage) {
        ...
        this.companyList = [];
        this.statusList = [..._shared__WEBPACK_IMPORTED_MODULE_12__["STATUSES"]];
    ...
    getCompanyList() {
        this.apiService.findAll(_shared__WEBPACK_IMPORTED_MODULE_12__["ENDPOINTS"].company).subscribe((res) => {
    ...
    getVoucherTrasnferDetails() {
        this.process = 'update';
        this.apiService.findById(_shared__WEBPACK_IMPORTED_MODULE_12__["ENDPOINTS"].voucher, this.formListComponent.idForUpdate).subscribe((res) => {
            if (res) {
    ...
    viewAttachmentFile() {
        this.apiService.findByParam(_shared__WEBPACK_IMPORTED_MODULE_12__["ENDPOINTS"].attachmentDocument, `voucher-attachment-reference/` + this.voucher.voucherAttachmentReference)
            .subscribe((res1) => {
            if (res1) {
    ...
    getVoucherTrasnferList() {
        this.apiService.findAll(_shared__WEBPACK_IMPORTED_MODULE_12__["ENDPOINTS"].voucher).subscribe((res) => {
    ...
    getCompanyReplenishmentList() {
        var _a;
        this.apiService.findAll(_shared__WEBPACK_IMPORTED_MODULE_12__["ENDPOINTS"].voucherReplenishmentsByCompany + ((_a = this.company) === null || _a === void 0 ? void 0 : _a.id)).subscribe((res) => {
            this.dataSourceReplenishments = new _angular_material_table__WEBPACK_IMPORTED_MODULE_6__["MatTableDataSource"](res.responseData.data);
    ...
    saveVoucherReplenishment() {
        this.apiService.save(_shared__WEBPACK_IMPORTED_MODULE_12__["ENDPOINTS"].accountingVoucherFundTransfer, this.voucherReplenishment).subscribe((res) => {
            console.log(res);
...
CompanyVoucherFundComponent.ctorParameters = () => [
...
CompanyVoucherFundComponent.propDecorators = {
    formListComponent: [{ type: _angular_core__WEBPACK_IMPORTED_MODULE_4__["ViewChild"], args: [_fragments__WEBPACK_IMPORTED_MODULE_9__["FormListComponent"],] }],
    safeURL: [{ type: _angular_core__WEBPACK_IMPORTED_MODULE_4__["Input"] }]
};
CompanyVoucherFundComponent = Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"])([
...
/* harmony import */ var _company_voucher_fund_routing_module__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ./company-voucher-fund-routing.module */ "8/m5");
/* harmony import */ var _company_voucher_fund_component__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! ./company-voucher-fund.component */ "FBay");
...
let CompanyVoucherFundModule = class CompanyVoucherFundModule {
};
CompanyVoucherFundModule = Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"])([
    Object(_angular_core__WEBPACK_IMPORTED_MODULE_1__["NgModule"])({
        declarations: [_company_voucher_fund_component__WEBPACK_IMPORTED_MODULE_4__["CompanyVoucherFundComponent"]],
        imports: [
            _angular_common__WEBPACK_IMPORTED_MODULE_2__["CommonModule"],
            _company_voucher_fund_routing_module__WEBPACK_IMPORTED_MODULE_3__["CompanyVoucherFundRoutingModule"],
