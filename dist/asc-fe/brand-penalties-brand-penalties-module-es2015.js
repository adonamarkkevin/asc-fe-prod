...
let BrandPenaltiesRoutingModule = class BrandPenaltiesRoutingModule {
};
BrandPenaltiesRoutingModule = Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"])([
...
/* harmony import */ var _brand_penalties_routing_module__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ./brand-penalties-routing.module */ "2FAk");
/* harmony import */ var _brand_penalties_component__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! ./brand-penalties.component */ "bmhz");
...
let BrandPenaltiesModule = class BrandPenaltiesModule {
};
BrandPenaltiesModule = Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"])([
    Object(_angular_core__WEBPACK_IMPORTED_MODULE_1__["NgModule"])({
        declarations: [_brand_penalties_component__WEBPACK_IMPORTED_MODULE_4__["BrandPenaltiesComponent"]],
        imports: [
            _angular_common__WEBPACK_IMPORTED_MODULE_2__["CommonModule"],
            _brand_penalties_routing_module__WEBPACK_IMPORTED_MODULE_3__["BrandPenaltiesRoutingModule"],
...
/* harmony import */ var tslib__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! tslib */ "mrSG");
/* harmony import */ var _raw_loader_brand_penalties_component_html__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! raw-loader!./brand-penalties.component.html */ "Feg1");
/* harmony import */ var _brand_penalties_component_scss__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ./brand-penalties.component.scss */ "sFGR");
...
/* harmony import */ var app_core_models_brand_penalties_model__WEBPACK_IMPORTED_MODULE_12__ = __webpack_require__(/*! app/core/models/brand-penalties.model */ "nOv4");
...
let BrandPenaltiesComponent = class BrandPenaltiesComponent {
    ...
    getBrandPenaltiesList() {
        this.apiService.findAll(_shared__WEBPACK_IMPORTED_MODULE_11__["ENDPOINTS"].brandPenalties).subscribe((res) => {
            if (res) {
                ...
                if (this.brand) {
                    ...
                    if (withPenalty) {
                        this.apiService.update(_shared__WEBPACK_IMPORTED_MODULE_11__["ENDPOINTS"].brand, this.brand).subscribe();
                    }
                }
            }
        }, err => {
    ...
    getBrandPenalties() {
        this.apiService.findById(_shared__WEBPACK_IMPORTED_MODULE_11__["ENDPOINTS"].brandPenalties, this.formListComponent.idForUpdate).subscribe((res) => {
            if (res) {
    ...
    getBrandList() {
        this.apiService.findAll(_shared__WEBPACK_IMPORTED_MODULE_11__["ENDPOINTS"].activeBrands).subscribe((res) => {
            if (res) {
    ...
    save() {
        this.formatDate();
        this.apiService.save(_shared__WEBPACK_IMPORTED_MODULE_11__["ENDPOINTS"].brandPenalties, this.brandPenalties).subscribe((res) => {
            if (res) {
    ...
    update() {
        this.apiService.update(_shared__WEBPACK_IMPORTED_MODULE_11__["ENDPOINTS"].brandPenalties, this.brandPenalties).subscribe((res) => {
            if (res) {
                this.sweetAlertService.success(res);
                this.router.navigate(['asc/page/maintenance/brand-penalties']);
            }
    ...
    delete() {
        sweetalert2__WEBPACK_IMPORTED_MODULE_13___default.a.fire({
            ...
            if (result.value) {
                this.apiService.deleteById(_shared__WEBPACK_IMPORTED_MODULE_11__["ENDPOINTS"].brandPenalties, this.brandPenalties.id).subscribe(() => {
...
BrandPenaltiesComponent.ctorParameters = () => [
...
BrandPenaltiesComponent.propDecorators = {
    formListComponent: [{ type: _angular_core__WEBPACK_IMPORTED_MODULE_4__["ViewChild"], args: [_fragments__WEBPACK_IMPORTED_MODULE_8__["FormListComponent"],] }]
};
BrandPenaltiesComponent = Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"])([
