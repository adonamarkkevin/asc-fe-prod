...
let VoucherBrandMonitoringRoutingModule = class VoucherBrandMonitoringRoutingModule {
};
VoucherBrandMonitoringRoutingModule = Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"])([
...
/* harmony import */ var _voucher_brand_monitoring_routing_module__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ./voucher-brand-monitoring-routing.module */ "8Y7v");
/* harmony import */ var _voucher_brand_monitoring_component__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! ./voucher-brand-monitoring.component */ "nGGm");
...
let VoucherBrandMonitoringModule = class VoucherBrandMonitoringModule {
};
VoucherBrandMonitoringModule = Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"])([
    Object(_angular_core__WEBPACK_IMPORTED_MODULE_1__["NgModule"])({
        declarations: [_voucher_brand_monitoring_component__WEBPACK_IMPORTED_MODULE_4__["VoucherBrandMonitoringComponent"]],
        imports: [
            _angular_common__WEBPACK_IMPORTED_MODULE_2__["CommonModule"],
            _voucher_brand_monitoring_routing_module__WEBPACK_IMPORTED_MODULE_3__["VoucherBrandMonitoringRoutingModule"],
...
/* harmony import */ var tslib__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! tslib */ "mrSG");
/* harmony import */ var _raw_loader_voucher_brand_monitoring_component_html__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! raw-loader!./voucher-brand-monitoring.component.html */ "P1i6");
/* harmony import */ var _voucher_brand_monitoring_component_scss__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ./voucher-brand-monitoring.component.scss */ "Dh6P");
...
let VoucherBrandMonitoringComponent = class VoucherBrandMonitoringComponent {
    ...
    getVocherMonitoring() {
        ...
        this.apiService.findAll(`${_shared__WEBPACK_IMPORTED_MODULE_10__["ENDPOINTS"].voucherMonitoring}?page=1&size=30`).subscribe((data) => {
            this.voucherList = data.data;
            this.dataSource = new _angular_material_table__WEBPACK_IMPORTED_MODULE_6__["MatTableDataSource"](this.voucherList);
    ...
    getBrandPenaltyMonitoring() {
        ...
        this.apiService.findAll(`${_shared__WEBPACK_IMPORTED_MODULE_10__["ENDPOINTS"].penalizedBrandMonitoring}/monitoring?page=1&size=30`).subscribe((data) => {
            this.brandPenalizedList = data.data;
            this.dataSource = new _angular_material_table__WEBPACK_IMPORTED_MODULE_6__["MatTableDataSource"](this.brandPenalizedList);
            this.dataSource.paginator = this.paginator;
            this.dataSource.sort = this.sort;
        });
    }
};
VoucherBrandMonitoringComponent.ctorParameters = () => [
...
VoucherBrandMonitoringComponent = Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"])([
