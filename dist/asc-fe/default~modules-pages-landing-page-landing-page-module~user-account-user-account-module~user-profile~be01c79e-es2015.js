...
UserAccountRoutingModule = Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"])([
...
/* harmony import */ var tslib__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! tslib */ "mrSG");
/* harmony import */ var _raw_loader_user_account_component_html__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! raw-loader!./user-account.component.html */ "YuNm");
/* harmony import */ var _user_account_component_scss__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ./user-account.component.scss */ "oYL1");
...
/* harmony import */ var _fragments__WEBPACK_IMPORTED_MODULE_11__ = __webpack_require__(/*! @fragments */ "3swC");
/* harmony import */ var _models__WEBPACK_IMPORTED_MODULE_12__ = __webpack_require__(/*! @models */ "sKXY");
/* harmony import */ var _services__WEBPACK_IMPORTED_MODULE_13__ = __webpack_require__(/*! @services */ "dJ3e");
/* harmony import */ var _shared__WEBPACK_IMPORTED_MODULE_14__ = __webpack_require__(/*! @shared */ "M0ag");
/* harmony import */ var app_core_models_eSignature_model__WEBPACK_IMPORTED_MODULE_15__ = __webpack_require__(/*! app/core/models/eSignature.model */ "Pwem");
...
/* harmony import */ var app_core_services_validate_field_service__WEBPACK_IMPORTED_MODULE_17__ = __webpack_require__(/*! app/core/services/validate-field.service */ "r74M");
/* harmony import */ var ngx_spinner__WEBPACK_IMPORTED_MODULE_18__ = __webpack_require__(/*! ngx-spinner */ "JqCM");
/* harmony import */ var sweetalert2__WEBPACK_IMPORTED_MODULE_19__ = __webpack_require__(/*! sweetalert2 */ "PSD3");
...
/* harmony import */ var _company_add_company_add_company_component__WEBPACK_IMPORTED_MODULE_20__ = __webpack_require__(/*! ../../company/add-company/add-company.component */ "9hFf");
...
let UserAccountComponent = class UserAccountComponent {
    ...
    save() {
        ...
        this.apiService.save(_shared__WEBPACK_IMPORTED_MODULE_14__["ENDPOINTS"].userAccount, this.userAccount).subscribe((res) => {
            if (res !== undefined) {
                this.sweetAlertService.customSuccessMessage('Account has been created successfully.');
                const evt = { index: null };
                if (this.userAccount.userRole.name === _shared__WEBPACK_IMPORTED_MODULE_14__["USER_ROLES"].ROLE_APPLICANT) {
                    evt.index = 0;
                }
                else {
                    evt.index = 1;
    ...
    update() {
        console.log('update');
        const endpoint = this.userAccount.userRole.name === _shared__WEBPACK_IMPORTED_MODULE_14__["USER_ROLES"].ROLE_APPLICANT ? _shared__WEBPACK_IMPORTED_MODULE_14__["ENDPOINTS"].userAccount : _shared__WEBPACK_IMPORTED_MODULE_14__["ENDPOINTS"].updateUserAccount;
    ...
    insert(isNewEntry) {
        ...
        // this.apiService.save(ENDPOINTS.addUserAccount, this.userAccount).subscribe(
        this.apiService.insert(_shared__WEBPACK_IMPORTED_MODULE_14__["ENDPOINTS"].userAccount, this.userAccount, isNewEntry).subscribe((res) => {
            if (res !== undefined) {
    ...
    updateCredentials() {
        ...
        this.apiService.update(_shared__WEBPACK_IMPORTED_MODULE_14__["ENDPOINTS"].updatePassword, updatedAccount).subscribe((res) => {
            if (res !== undefined) {
    ...
    getSelectedCompany(i) {
        if (i) {
            this.apiService.findById(_shared__WEBPACK_IMPORTED_MODULE_14__["ENDPOINTS"].company, i.value.id).subscribe((res) => {
    ...
    getUserPerTypeList(type = 'APPLICANT') {
        ...
        this.apiService.findAll(`${_shared__WEBPACK_IMPORTED_MODULE_14__["ENDPOINTS"].userAccountType}/${type}`).subscribe((res) => {
    ...
    getMaintenanceList() {
        this.apiService.findAll(_shared__WEBPACK_IMPORTED_MODULE_14__["ENDPOINTS"].activeCompanies).subscribe((res) => {
            this.companyList = res.responseData.data;
        }, (err) => {
        });
        this.apiService.findAll(_shared__WEBPACK_IMPORTED_MODULE_14__["ENDPOINTS"].activeMembersAffiliation).subscribe((res) => {
            this.affiliationList = res.responseData.data;
        }, (err) => {
        });
        this.apiService.findAll(_shared__WEBPACK_IMPORTED_MODULE_14__["ENDPOINTS"].roles).subscribe((res) => {
    ...
    viewUserInformation() {
        ...
        this.apiService.findById(_shared__WEBPACK_IMPORTED_MODULE_14__["ENDPOINTS"].userAccount, accountId).subscribe((res) => {
    ...
    openCompanyComponent() {
        const dialogRef = this.dialog.open(_company_add_company_add_company_component__WEBPACK_IMPORTED_MODULE_20__["AddCompanyComponent"], {
            width: '80%',
            height: '85%',
            data: {
                isFromModal: true,
    ...
    uploadSignature() {
        sweetalert2__WEBPACK_IMPORTED_MODULE_19___default.a.fire({
            ...
            if (result.value) {
                ...
                this.fileStorageService.pushFileToStorage(_shared__WEBPACK_IMPORTED_MODULE_14__["ENDPOINTS"].signature, this.selectedFile, params)
                    .subscribe((res) => {
    ...
    updateUserSignatureReference() {
        const endpoint = this.isAscUser ? _shared__WEBPACK_IMPORTED_MODULE_14__["ENDPOINTS"].userAccount : _shared__WEBPACK_IMPORTED_MODULE_14__["ENDPOINTS"].updateUserAccount;
        this.apiService.update(endpoint, this.userAccount).subscribe((res) => {
            console.log(res);
        });
    }
    ...
    getEsignature() {
        ...
        const accountId = ((_a = this.formListComponent) === null || _a === void 0 ? void 0 : _a.idForUpdate) ?
            this.formListComponent.idForUpdate : this.userAccount.id;
        this.spinner.show();
        this.apiService.findByParam(`${_shared__WEBPACK_IMPORTED_MODULE_14__["ENDPOINTS"].signature}/account-id`, accountId).subscribe((res) => {
            var _a;
            if (res) {
    ...
    resendEmail() {
        this.apiService.save(_shared__WEBPACK_IMPORTED_MODULE_14__["ENDPOINTS"].adminResendVerificationCode + `/${this.userAccount.username}`, this.userAccount).subscribe((res) => {
    ...
    deleteESignature() {
        sweetalert2__WEBPACK_IMPORTED_MODULE_19___default.a.fire({
            ...
            if (result.value) {
                this.spinner.show();
                this.apiService.deleteById(_shared__WEBPACK_IMPORTED_MODULE_14__["ENDPOINTS"].signature, (_a = this.eSign) === null || _a === void 0 ? void 0 : _a.id).subscribe(res => {
                    this.eSign = new app_core_models_eSignature_model__WEBPACK_IMPORTED_MODULE_15__["ESignature"]();
                    this.previewDocument = false;
                    this.spinner.hide();
...
UserAccountComponent.propDecorators = {
    formListComponent: [{ type: _angular_core__WEBPACK_IMPORTED_MODULE_3__["ViewChild"], args: [_fragments__WEBPACK_IMPORTED_MODULE_11__["FormListComponent"],] }],
    ...
    selectFileButton: [{ type: _angular_core__WEBPACK_IMPORTED_MODULE_3__["ViewChild"], args: ['selectFileButton', { static: false },] }]
};
...
/* harmony import */ var _user_account_routing_module__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ./user-account-routing.module */ "B0iI");
/* harmony import */ var _user_account_component__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! ./user-account.component */ "ea/y");
...
UserAccountModule = Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"])([
    Object(_angular_core__WEBPACK_IMPORTED_MODULE_1__["NgModule"])({
        ...
        imports: [
            ...
            _user_account_routing_module__WEBPACK_IMPORTED_MODULE_3__["UserAccountRoutingModule"],
