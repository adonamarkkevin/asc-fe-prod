...
/* harmony import */ var _user_registration_component__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ./user-registration.component */ "Jsen");
...
let UserRegistrationRoutingModule = class UserRegistrationRoutingModule {
};
UserRegistrationRoutingModule = Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"])([
...
/* harmony import */ var tslib__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! tslib */ "mrSG");
/* harmony import */ var _raw_loader_user_registration_component_html__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! raw-loader!./user-registration.component.html */ "dw2r");
/* harmony import */ var _user_registration_component_scss__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ./user-registration.component.scss */ "Jqmd");
...
/* harmony import */ var _company__WEBPACK_IMPORTED_MODULE_10__ = __webpack_require__(/*! @company */ "zeqK");
/* harmony import */ var _models__WEBPACK_IMPORTED_MODULE_11__ = __webpack_require__(/*! @models */ "sKXY");
/* harmony import */ var _services__WEBPACK_IMPORTED_MODULE_12__ = __webpack_require__(/*! @services */ "dJ3e");
/* harmony import */ var _shared__WEBPACK_IMPORTED_MODULE_13__ = __webpack_require__(/*! @shared */ "M0ag");
...
/* harmony import */ var _core_models_email_model__WEBPACK_IMPORTED_MODULE_15__ = __webpack_require__(/*! ../../../../core/models/email.model */ "5ZJz");
...
let UserRegistrationComponent = class UserRegistrationComponent {
    ...
    dialogRef, data) {
        ...
        this.statusList = [..._shared__WEBPACK_IMPORTED_MODULE_13__["STATUSES"]];
    ...
    getList() {
        this.apiService.findAll(_shared__WEBPACK_IMPORTED_MODULE_13__["ENDPOINTS"].activeCompanies).subscribe((res) => {
            this.companyList = res.responseData.data;
            console.log(this.companyList);
        });
        this.apiService.findAll(_shared__WEBPACK_IMPORTED_MODULE_13__["ENDPOINTS"].activeMembersAffiliation).subscribe((res) => {
            this.affiliationList = res.responseData.data;
        });
    }
    viewUserInformation() {
        this.apiService.findById(_shared__WEBPACK_IMPORTED_MODULE_13__["ENDPOINTS"].userAccount, this.id).subscribe((res) => {
    ...
    getSelectedCompany(i) {
        if (i) {
            this.apiService.findById(_shared__WEBPACK_IMPORTED_MODULE_13__["ENDPOINTS"].company, i.value.id).subscribe((res) => {
    ...
    openCompanyComponent() {
        const dialogRef = this.dialog.open(_company__WEBPACK_IMPORTED_MODULE_10__["AddCompanyComponent"], {
            width: '80%',
            height: '85%',
            data: {
                isFromModal: true,
    ...
    save() {
        ...
        this.apiService.save(_shared__WEBPACK_IMPORTED_MODULE_13__["ENDPOINTS"].addUserAccount, this.userAccount).subscribe((res) => {
            if (res !== undefined) {
    ...
    update() {
        this.apiService.update(_shared__WEBPACK_IMPORTED_MODULE_13__["ENDPOINTS"].updateUserAccount, this.userAccount).subscribe((res) => {
            if (res !== undefined) {
                this.sweetAlertService.success(res);
    ...
    checkProcessStatus() {
        if (this.dataStorage.getUserAccount().id !== 0) {
            this.process = 'UPDATE';
            this.apiService.findById(_shared__WEBPACK_IMPORTED_MODULE_13__["ENDPOINTS"].userAccount, this.dataStorage.getUserAccount().id).subscribe((res) => {
                this.userAccount = res.responseData.data;
                this.apiService.findById(_shared__WEBPACK_IMPORTED_MODULE_13__["ENDPOINTS"].company, this.userAccount.company.id).subscribe((res1) => {
...
UserRegistrationComponent.propDecorators = {
    ...
    table: [{ type: _angular_core__WEBPACK_IMPORTED_MODULE_3__["ViewChild"], args: [_angular_material_table__WEBPACK_IMPORTED_MODULE_8__["MatTable"], { static: false },] }]
};
UserRegistrationComponent = Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"])([
...
/* harmony import */ var _user_registration_routing_module__WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__(/*! ./user-registration-routing.module */ "3v23");
/* harmony import */ var _user_registration_component__WEBPACK_IMPORTED_MODULE_7__ = __webpack_require__(/*! ./user-registration.component */ "Jsen");
...
let UserRegistrationModule = class UserRegistrationModule {
};
UserRegistrationModule = Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"])([
    Object(_angular_core__WEBPACK_IMPORTED_MODULE_1__["NgModule"])({
        declarations: [_user_registration_component__WEBPACK_IMPORTED_MODULE_7__["UserRegistrationComponent"]],
        imports: [
            _angular_common__WEBPACK_IMPORTED_MODULE_2__["CommonModule"],
            _user_registration_routing_module__WEBPACK_IMPORTED_MODULE_6__["UserRegistrationRoutingModule"],
        ...
        exports: [
            _user_registration_component__WEBPACK_IMPORTED_MODULE_7__["UserRegistrationComponent"]
        ]
    })
