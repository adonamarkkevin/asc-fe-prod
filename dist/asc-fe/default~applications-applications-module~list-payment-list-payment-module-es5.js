(function () {
  ...
  (window["webpackJsonp"] = window["webpackJsonp"] || []).push([["default~applications-applications-module~list-payment-list-payment-module"], {
    ...
    function iOt(module, __webpack_exports__, __webpack_require__) {
      ...
      function ListPaymentComponent_td_16_Template(rf, ctx) {
        if (rf & 1) {
          ...
          _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵlistener"]("click", function ListPaymentComponent_td_16_Template_td_click_0_listener() {
            ...
            return ctx_r15.getPaymentDetails(element_r14.id);
          });
      ...
      function ListPaymentComponent_td_19_Template(rf, ctx) {
        if (rf & 1) {
          ...
          _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵlistener"]("click", function ListPaymentComponent_td_19_Template_td_click_0_listener() {
            ...
            return ctx_r18.getPaymentDetails(element_r17.id);
          });
      ...
      function ListPaymentComponent_td_22_Template(rf, ctx) {
        if (rf & 1) {
          ...
          _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵlistener"]("click", function ListPaymentComponent_td_22_Template_td_click_0_listener() {
            ...
            return ctx_r21.getPaymentDetails(element_r20.id);
          });
      ...
      function ListPaymentComponent_td_25_Template(rf, ctx) {
        if (rf & 1) {
          ...
          _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵlistener"]("click", function ListPaymentComponent_td_25_Template_td_click_0_listener() {
            ...
            return ctx_r24.getPaymentDetails(element_r23.id);
          });
      ...
      function ListPaymentComponent_td_28_Template(rf, ctx) {
        if (rf & 1) {
          ...
          _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵlistener"]("click", function ListPaymentComponent_td_28_Template_td_click_0_listener() {
            ...
            return ctx_r27.getPaymentDetails(element_r26.id);
          });
      ...
      function ListPaymentComponent_td_31_Template(rf, ctx) {
        if (rf & 1) {
          ...
          _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵlistener"]("click", function ListPaymentComponent_td_31_Template_td_click_0_listener() {
            ...
            return ctx_r30.getPaymentDetails(element_r29.id);
          });
      ...
      var ListPaymentComponent = /*@__PURE__*/function () {
        var ListPaymentComponent = /*#__PURE__*/function () {
          ...
          _createClass(ListPaymentComponent, [{
            ...
            value: function getS1PaymentList() {
              ...
              this.apiService.findAll(_shared__WEBPACK_IMPORTED_MODULE_4__["ENDPOINTS"].accountingPaymentForApprovals + endpoint).subscribe(function (res) {
                _this2.paymentList = res.responseData.data;
                console.log('payment list:: ', _this2.paymentList);
                _this2.dataSource = new _angular_material_table__WEBPACK_IMPORTED_MODULE_3__["MatTableDataSource"](_this2.paymentList); // this.dataSource.paginator = this.paginator;
        ...
        ListPaymentComponent.ɵfac = function ListPaymentComponent_Factory(t) {
          return new (t || ListPaymentComponent)(_angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵdirectiveInject"](_angular_router__WEBPACK_IMPORTED_MODULE_5__["Router"]), _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵdirectiveInject"](_services__WEBPACK_IMPORTED_MODULE_6__["ApiService"]));
        };

        ListPaymentComponent.ɵcmp = _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵdefineComponent"]({
          type: ListPaymentComponent,
          selectors: [["app-list-payment"]],
          viewQuery: function ListPaymentComponent_Query(rf, ctx) {
            if (rf & 1) {
          ...
          decls: 37,
          vars: 8,
          consts: [[1, "container-fluid"], [1, "row"], [1, "col-md-12", "title"], ["fxLayout", "", "fxLayoutAlign", "center center", 1, "col-md-12"], ["matInput", "", "type", "text", "placeholder", "Search", 3, "keyup"], [1, "mat-elevation-z8", "fields"], ["mat-table", "", "matSort", "", 3, "dataSource"], ["matColumnDef", "referenceCode"], ["mat-header-cell", "", 4, "matHeaderCellDef"], ["mat-cell", "", 3, "click", 4, "matCellDef"], ["matColumnDef", "typeOfApplication"], ["matColumnDef", "brand"], ["matColumnDef", "typeOfMedium"], ["matColumnDef", "companyName"], ["matColumnDef", "paymentStatus"], ["mat-header-row", "", 4, "matHeaderRowDef"], ["mat-row", "", 4, "matRowDef", "matRowDefColumns"], [1, "no-record", 3, "hidden"], [3, "pageSize", "pageIndex", "length", "pageSizeOptions", "page"], ["mat-header-cell", ""], ["mat-cell", "", 3, "click"], ["mat-header-row", ""], ["mat-row", ""]],
          template: function ListPaymentComponent_Template(rf, ctx) {
            if (rf & 1) {
              ...
              _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵlistener"]("keyup", function ListPaymentComponent_Template_input_keyup_11_listener($event) {
              ...
              _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵlistener"]("page", function ListPaymentComponent_Template_mat_paginator_page_36_listener($event) {
    ...
    function O1SJ(module, __webpack_exports__, __webpack_require__) {
      ...
      var _list_payment_routing_module__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(
      ...
      var ListPaymentModule = /*@__PURE__*/function () {
        var ListPaymentModule = /*#__PURE__*/_createClass(function ListPaymentModule() {
          _classCallCheck(this, ListPaymentModule);
        });

        ListPaymentModule.ɵmod = _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵdefineNgModule"]({
          type: ListPaymentModule
        });
        ListPaymentModule.ɵinj = _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵdefineInjector"]({
          factory: function ListPaymentModule_Factory(t) {
            return new (t || ListPaymentModule)();
          },
          imports: [[_angular_common__WEBPACK_IMPORTED_MODULE_1__["CommonModule"], _list_payment_routing_module__WEBPACK_IMPORTED_MODULE_2__["ListPaymentRoutingModule"], _shared__WEBPACK_IMPORTED_MODULE_4__["AngularMaterialModule"]]]
        });
        return ListPaymentModule;
      }();

      (function () {
        (typeof ngJitMode === "undefined" || ngJitMode) && _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵsetNgModuleScope"](ListPaymentModule, {
          declarations: [_list_payment_component__WEBPACK_IMPORTED_MODULE_3__["ListPaymentComponent"]],
          imports: [_angular_common__WEBPACK_IMPORTED_MODULE_1__["CommonModule"], _list_payment_routing_module__WEBPACK_IMPORTED_MODULE_2__["ListPaymentRoutingModule"], _shared__WEBPACK_IMPORTED_MODULE_4__["AngularMaterialModule"]]
        });
      })();
      /***/
    ...
    function xKaw(module, __webpack_exports__, __webpack_require__) {
      ...
      var _list_payment_component__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(
      /*! ./list-payment.component */
      "5iOt");
      ...
      var ListPaymentRoutingModule = /*@__PURE__*/function () {
        ...
        ListPaymentRoutingModule.ɵmod = _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵdefineNgModule"]({
          type: ListPaymentRoutingModule
        });
        ListPaymentRoutingModule.ɵinj = _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵdefineInjector"]({
          factory: function ListPaymentRoutingModule_Factory(t) {
            return new (t || ListPaymentRoutingModule)();
          },
      ...
      (function () {
        (typeof ngJitMode === "undefined" || ngJitMode) && _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵsetNgModuleScope"](ListPaymentRoutingModule, {
...
//# sourceMappingURL=default~applications-applications-module~list-payment-list-payment-module-es5.js.map