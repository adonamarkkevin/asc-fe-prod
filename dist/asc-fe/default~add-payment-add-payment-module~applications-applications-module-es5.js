          ...
          _createClass(AddPaymentComponent, [{
            ...
            value: function getPaymentDetails() {
              ...
              this.apiService.findAll(endpoint + this.id).subscribe(function (res) {
                ...
                if (res.responseData) {
                  ...
                  _this3.payment.filedBirForm = _this3.payment.filedBirForm ? _this3.payment.filedBirForm : false;
                ...
                if (_this3.payment.paymentAttachmentReference) {
            ...
            value: function viewPayment() {
              ...
              this.apiService.findByParam(endpoint, this.id).subscribe(function (res) {
                ...
                if (_this5.payment.paymentAttachmentReference) {
                  _this5.getAttachmentDocumentDisplay(_this5.payment.paymentAttachmentReference);
                }

                switch (((_e = (_d = _this5.payment) === null || _d === void 0 ? void 0 : _d.applicationForm) === null || _e === void 0 ? void 0 : _e.refTypeOfMedium) || ((_h = (_g = (_f = _this5.payment) === null || _f === void 0 ? void 0 : _f.applicationFormS2) === null || _g === void 0 ? void 0 : _g.applicationForm) === null || _h === void 0 ? void 0 : _h.refTypeOfMedium)) {
                  case 'SINGLE MEDIA':
            ...
            value: function processPayment(remarks) {
              ...
              var toPay = this.payment.amountDue - this.payment.withholdingTax;
          ...
          template: function AddPaymentComponent_Template(rf, ctx) {
            if (rf & 1) {
              ...
              _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵlistener"]("ngModelChange", function AddPaymentComponent_Template_mat_checkbox_ngModelChange_59_listener($event) {
                return ctx.payment.filedBirForm = $event;
